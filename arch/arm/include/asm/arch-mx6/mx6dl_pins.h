...
enum {
	...
	MX6_PAD_GPIO_16__ENET_ANATOP_ETHERNET_REF_OUT	= IOMUX_PAD(0x05E4, 0x0214, 2 | IOMUX_CONFIG_SION, 0x080C, 0, 0),
	...
	MX6_PAD_RGMII_TX_CTL__ENET_ANATOP_ETHERNET_REF_OUT	= IOMUX_PAD(0x06BC, 0x02D4, 7 | IOMUX_CONFIG_SION, 0x080C, 1, 0),
