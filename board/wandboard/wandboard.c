...
static iomux_v3_cfg_t const usdhc1_pads[] = {
	...
	IOMUX_PADS(PAD_GPIO_2__GPIO1_IO02),
};
...
static iomux_v3_cfg_t const usdhc3_pads[] = {
	...
	IOMUX_PADS(PAD_EIM_DA9__GPIO3_IO09),
};
...
static iomux_v3_cfg_t const fwadapt_7wvga_pads[] = {
	...
	IOMUX_PADS(PAD_SD4_DAT2__GPIO2_IO10), /* DISP0_BKLEN */
	IOMUX_PADS(PAD_SD4_DAT3__GPIO2_IO11), /* DISP0_VDDEN */
};
